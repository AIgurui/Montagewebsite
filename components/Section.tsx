...
type Props = { id?: string; nextId?: string; title?: string; eyebrow?: string; children: React.ReactNode };

export default function Section({ id, nextId, title, eyebrow, children }: Props) {
  return (
