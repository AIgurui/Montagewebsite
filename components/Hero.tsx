  ...
  return (
    <section className="relative isolate overflow-hidden">
      ...
      <div className="relative container px-6 py-20 text-white md:py-28 min-h-[56vh] md:min-h-[66vh] flex flex-col justify-center">
        ...
        <a href="#kpi" aria-label="Go to next section" className="group absolute bottom-4 right-4 md:bottom-6 md:right-6 inline-flex items-center justify-center rounded-full bg-brand-600 p-2.5 md:p-3 text-white shadow-lg hover:bg-brand-700 focus-visible:shadow-focus transition-all hover:scale-110">
