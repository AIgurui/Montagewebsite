        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="rounded-lg sm:rounded-xl border border-neutral-200 bg-white overflow-hidden">
              <div className="px-4 sm:px-6 py-3 sm:py-4 font-semibold text-base sm:text-lg !text-black bg-neutral-50">
                Latin America
              </div>
              <div className="px-4 sm:px-6 py-3 sm:py-4 text-sm sm:text-base !text-black">
                <p>
