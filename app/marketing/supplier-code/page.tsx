  ...
  return (
    <>
      <Section id="intro" title="Supplier Code of Conduct" className="bg-neutral-50">
        <h2 className="text-2xl font-bold text-neutral-900 mb-4">Part 1: Introduction</h2>

        <h3 className="text-xl font-semibold text-neutral-900 mb-3 mt-6">Our Commitment</h3>
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3 mt-6">Purpose and Scope</h3>
        <p className="text-neutral-900 mb-4">
      ...
      <Section id="labour-standards" title="Part 2: Labour Standards and Human Rights">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Fundamental Principles</h3>
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Prohibition of Forced Labour and Human Trafficking</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <p className="text-neutral-900 mb-2">In particular, Suppliers must:</p>
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Prevention of Child Labour</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Fair Wages and Working Hours</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Equal Treatment and Non-Discrimination</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Freedom of Association</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Workplace Conduct and Discipline</h3>
        <p className="text-neutral-900">
      ...
      <Section id="health-safety" title="Part 3: Health, Safety and Environment" className="bg-neutral-50">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Occupational Health and Safety</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <p className="text-neutral-900 mb-2">Suppliers must:</p>
        <ul className="list-disc list-inside space-y-2 text-neutral-900 ml-4 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Environmental Responsibility</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <p className="text-neutral-900 mb-2">This includes responsible management of:</p>
      ...
      <Section id="business-ethics" title="Part 4: Business Ethics and Integrity">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Anti-Corruption and Bribery</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Conflicts of Interest</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Fair Competition</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Financial Integrity and Anti-Money Laundering</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Trade Compliance and Sanctions</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Data Protection and Confidentiality</h3>
        <p className="text-neutral-900 mb-4">
      ...
      <Section id="management-compliance" title="Part 5: Management and Compliance" className="bg-neutral-50">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Implementation and Communication</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Supply Chain Responsibility</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Business Continuity</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Reporting Concerns</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <div className="p-6 bg-white rounded-lg border border-neutral-200 mb-6">
          <p className="text-neutral-900 mb-1">Email: <a href="mailto:compliance@montagefert.com" className="text-brand-600 hover:text-brand-700 font-semibold">compliance@montagefert.com</a></p>
          <p className="text-neutral-900">Post: Compliance Officer, Montage, Office 1302, Saba 1, Jumeirah Lake Towers, Dubai, UAE</p>
        </div>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Verification and Audit</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">Non-Compliance and Remediation</h3>
        <p className="text-neutral-900 mb-4">
