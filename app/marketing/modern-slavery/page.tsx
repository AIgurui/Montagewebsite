  ...
  return (
    <>
      <Section id="intro" title="Modern Slavery Policy" className="bg-neutral-50">
        <h2 className="text-2xl font-bold text-neutral-900 mb-4">1. Our Position on Modern Slavery</h2>

        <h3 className="text-xl font-semibold text-neutral-900 mb-3 mt-6">1.1 Zero Tolerance</h3>
      ...
      <Section id="understanding" title="2. Understanding Modern Slavery">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">2.1 What Is Modern Slavery?</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <p className="text-neutral-900 mb-2">Modern slavery encompasses a range of exploitative practices, including:</p>
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">2.2 Recognising the Warning Signs</h3>
        <p className="text-neutral-900 mb-4">
      ...
      <Section id="applicability" title="3. Who This Policy Applies To" className="bg-neutral-50">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">3.1 Our People</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">3.2 Our Business Partners</h3>
      ...
      <Section id="prevention" title="4. Our Approach to Preventing Modern Slavery">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">4.1 Risk Assessment</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <p className="text-neutral-900 mb-2">We recognise that certain aspects of our business may present elevated risks, including:</p>
        <ul className="list-disc list-inside space-y-2 text-neutral-900 ml-4 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">4.2 Due Diligence</h3>
        <p className="text-neutral-900 mb-2">We conduct due diligence on our supply chains to identify and address modern slavery risks. Our due diligence measures include:</p>
        <ul className="list-disc list-inside space-y-2 text-neutral-900 ml-4 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">4.3 Contractual Protections</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">4.4 Training and Awareness</h3>
        <p className="text-neutral-900">
      ...
      <Section id="responsibilities" title="5. Responsibilities" className="bg-neutral-50">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">5.1 All Personnel</h3>
        <p className="text-neutral-900 mb-2">Every person covered by this Policy has a responsibility to:</p>
        <ul className="list-disc list-inside space-y-2 text-neutral-900 ml-4 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">5.2 Management</h3>
        <p className="text-neutral-900 mb-2">Managers and supervisors have additional responsibilities to:</p>
        <ul className="list-disc list-inside space-y-2 text-neutral-900 ml-4 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">5.3 Procurement and Supply Chain Teams</h3>
        <p className="text-neutral-900 mb-2">Those involved in procurement and supply chain management have specific responsibilities to:</p>
        <ul className="list-disc list-inside space-y-2 text-neutral-900 ml-4">
      ...
      <Section id="reporting" title="6. Reporting Concerns">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">6.1 Obligation to Report</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">6.2 How to Report</h3>
        <p className="text-neutral-900 mb-4">Concerns may be reported through the following channels:</p>

        <div className="space-y-4 mb-6">
          <div className="p-6 bg-neutral-50 rounded-lg border border-neutral-200">
            <p className="font-semibold text-neutral-900 mb-1">Compliance Team</p>
            <p className="text-neutral-900">Email: <a href="mailto:compliance@montagefert.com" className="text-brand-600 hover:text-brand-700 font-semibold">compliance@montagefert.com</a></p>
            <p className="text-sm text-neutral-600 mt-2">This is the primary channel for reporting modern slavery concerns.</p>
          </div>

          <div className="p-6 bg-neutral-50 rounded-lg border border-neutral-200">
            <p className="font-semibold text-neutral-900 mb-1">Chief Executive Officer</p>
            <p className="text-neutral-900 text-sm">Reports may also be made directly to the CEO, particularly for matters of significant concern.</p>
          </div>

          <div className="p-6 bg-neutral-50 rounded-lg border border-neutral-200">
            <p className="font-semibold text-neutral-900 mb-1">Whistleblower Channels</p>
            <p className="text-neutral-900 text-sm">For those who wish to report anonymously or who have concerns about retaliation, reports may be made through the channels described in our Whistleblower Policy.</p>
          </div>
        </div>

        <h3 className="text-xl font-semibold text-neutral-900 mb-3">6.3 Protection from Retaliation</h3>
        <p className="text-neutral-900 mb-4">
      ...
      <Section id="response" title="7. Responding to Modern Slavery Concerns" className="bg-neutral-50">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">7.1 Investigation</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">7.2 Remediation</h3>
        <p className="text-neutral-900 mb-4">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">7.3 Consequences for Non-Compliance</h3>
        <p className="text-neutral-900 mb-4">
      ...
      <Section id="governance" title="8. Governance and Review">
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">8.1 Oversight</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">8.2 Monitoring and Reporting</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">8.3 Policy Review</h3>
        <p className="text-neutral-900 mb-6">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 mb-3">8.4 Related Policies</h3>
      ...
      <Section id="contact" title="9. Contact" className="bg-neutral-50">
        <p className="text-neutral-900 mb-4">For questions about this Policy or to report a concern, please contact:</p>
        <div className="p-6 bg-white rounded-lg border border-neutral-200 mb-6">
          <p className="font-semibold text-neutral-900 mb-2">Compliance Team</p>
