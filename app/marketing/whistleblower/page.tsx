  ...
  return (
    <>
      <Section id="intro" title="Whistleblower Policy" className="bg-neutral-50">
        <h2 className="text-2xl font-bold !text-black mb-4">1. Introduction and Purpose</h2>

        <h3 className="text-xl font-semibold !text-black mb-3 mt-6">1.1 Our Commitment</h3>
        ...
        <p className="!text-black mb-2">This Whistleblower Policy (&ldquo;Policy&rdquo;) establishes a framework for:</p>
        ...
        <h3 className="text-xl font-semibold !text-black mb-3 mt-6">1.3 Scope and Application</h3>
      ...
      <Section id="reportable-conduct" title="2. What Can Be Reported">
        <h3 className="text-xl font-semibold !text-black mb-3">2.1 Reportable Conduct</h3>
        <p className="!text-black mb-4">
        ...
        <p className="!text-black mb-2">Reportable conduct includes, but is not limited to:</p>
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">2.2 What This Policy Does Not Cover</h3>
        <p className="!text-black mb-4">
        ...
        <p className="!text-black mb-2">The following matters should generally be raised through other channels:</p>
        <ul className="list-disc list-inside space-y-2 !text-black ml-4 mb-4">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">2.3 Requirement for Good Faith</h3>
        <p className="!text-black mb-4">
      ...
      <Section id="how-to-report" title="3. How to Report a Concern" className="bg-neutral-50">
        <h3 className="text-xl font-semibold !text-black mb-3">3.1 Internal Reporting Channels</h3>
        <p className="!text-black mb-4">
        ...
        <div className="mb-6">
          <h4 className="font-semibold !text-black mb-2">Designated Compliance Officer</h4>
          <p className="!text-black mb-4">
          ...
          <h4 className="font-semibold !text-black mb-2">Senior Management</h4>
          <p className="!text-black mb-4">
          ...
          <h4 className="font-semibold !text-black mb-2">External Legal Counsel</h4>
          <p className="!text-black">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3 mt-6">3.2 Anonymous Reporting</h3>
        <p className="!text-black mb-4">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">3.3 External Reporting</h3>
        <p className="!text-black mb-4">
        ...
        <p className="!text-black mb-2">Relevant external authorities may include:</p>
        <ul className="list-disc list-inside space-y-2 !text-black ml-4 mb-4">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">3.4 Contact Information</h3>
        <p className="!text-black mb-4">Reports may be submitted to:</p>
        <div className="p-6 bg-white rounded-lg border border-neutral-200">
          <p className="font-semibold !text-black mb-2">Compliance Officer</p>
      ...
      <Section id="protection" title="4. Protection of Reporters">
        <h3 className="text-xl font-semibold !text-black mb-3">4.1 Prohibition of Retaliation</h3>
        <p className="!text-black mb-4">
        ...
        <p className="!text-black mb-2">Retaliation includes, but is not limited to:</p>
        <ul className="list-disc list-inside space-y-2 !text-black ml-4 mb-4">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">4.2 Confidentiality</h3>
        <p className="!text-black mb-4">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">4.3 Secure Record Keeping</h3>
        <p className="!text-black mb-6">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">4.4 Support for Reporters</h3>
        <p className="!text-black">
      ...
      <Section id="investigation" title="5. Investigation Process" className="bg-neutral-50">
        <h3 className="text-xl font-semibold !text-black mb-3">5.1 Initial Assessment</h3>
        <p className="!text-black mb-4">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">5.2 Conducting the Investigation</h3>
        <p className="!text-black mb-4">
        ...
        <p className="!text-black mb-2">The investigation will typically involve:</p>
        <ul className="list-disc list-inside space-y-2 !text-black ml-4 mb-6">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">5.3 Timeframes</h3>
        <p className="!text-black mb-6">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">5.4 Outcomes and Follow-Up</h3>
        <p className="!text-black mb-4">
      ...
      <Section id="fair-treatment" title="6. Fair Treatment of Persons Subject to Reports">
        <h3 className="text-xl font-semibold !text-black mb-3">6.1 Presumption of Innocence</h3>
        <p className="!text-black mb-6">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">6.2 Confidentiality</h3>
        <p className="!text-black mb-6">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">6.3 Right to Respond</h3>
        <p className="!text-black mb-6">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">6.4 Support</h3>
        <p className="!text-black">
      ...
      <Section id="governance" title="7. Policy Governance" className="bg-neutral-50">
        <h3 className="text-xl font-semibold !text-black mb-3">7.1 Ownership and Review</h3>
        <p className="!text-black mb-6">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">7.2 Training and Awareness</h3>
        <p className="!text-black mb-6">
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">7.3 Related Policies</h3>
        ...
        <h3 className="text-xl font-semibold !text-black mb-3">7.4 Amendments</h3>
        <p className="!text-black">
