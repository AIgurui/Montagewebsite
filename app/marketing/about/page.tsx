  ...
  return (
    <>
      <Section id="about-intro" eyebrow="About" title="Global network. Local execution." nextId="safety-compliance">
        <p>
          Montage Oil DMCC is a Dubai-based international trading company specialising in fertilizers. The company is part of a global network with leading market positions across Latin America, the Middle East, Southeast Asia, and Africa.
        </p>
        <p>
