  ...
  return (
    <>
        ...
        <div className="container px-4">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="mb-4 md:mb-6 max-w-2xl text-base sm:text-lg md:text-xl text-neutral-900">
      ...
      <section className="relative pb-6 md:pb-8">
        <div className="container px-4">
          <div className="mb-3 md:mb-4">
            <h3 className="text-xl md:text-2xl font-bold text-neutral-900">Nitrogen</h3>
            <p className="text-sm md:text-base text-neutral-900">Essential for protein synthesis and chlorophyll production</p>
          </div>
          <div className="grid gap-3 md:gap-4 sm:grid-cols-2 md:grid-cols-3">
            {nitrogenProducts.map((product) => (
              <div key={product} className="group rounded-lg md:rounded-xl border border-neutral-200 bg-white p-4 md:p-6 shadow-sm transition-all hover:shadow-md hover:border-teal-300">
                <h4 className="text-base md:text-lg font-semibold text-neutral-900">{product}</h4>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative pb-6 md:pb-8">
        <div className="container px-4">
          <div className="mb-3 md:mb-4">
            <h3 className="text-xl md:text-2xl font-bold text-neutral-900">Potash</h3>
            <p className="text-sm md:text-base text-neutral-900">Vital for water regulation and disease resistance</p>
          </div>
      ...
      <section className="relative pb-8 md:pb-12">
        <div className="container px-4">
          <div className="mb-3 md:mb-4">
            <h3 className="text-xl md:text-2xl font-bold text-neutral-900">Phosphate</h3>
            <p className="text-sm md:text-base text-neutral-900">Critical for root development and energy transfer</p>
          </div>
          <div className="grid gap-3 md:gap-4 sm:grid-cols-2 md:grid-cols-3">
